...
namespace TaskManager.Tasks
{
    public class Bug : BaseTask, IAssignable
    {
        ...
        /// </summary>
        /// <returns>Информация о задаче Bug.</returns>
        public override string ToString()
        {
            string output;

            output = $"Тип задачи: Bug, название задачи: {this.Name}, дата создания задачи: {this.CreationDate}, статус задачи: {this.Status}";
